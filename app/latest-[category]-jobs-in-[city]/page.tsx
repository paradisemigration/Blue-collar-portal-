...
export default function JobListingPage({ params }: PageProps) {
  ...
  useEffect(() => {
    const validCities = UAE_CITIES.map(city => city.toLowerCase().replace(/\s+/g, '-'))
  ...
  const companies = UAE_COMPANIES[cityDisplay] || []
  ...
  const generateFAQs = () => {
    const baseFAQs = [
      ...
      },
      {
        ...
        answer: `Salaries for ${categoryDisplay.toLowerCase()} in ${cityDisplay} vary based on experience, company size, and specific role. Most positions offer competitive packages including accommodation, transportation, and health insurance benefits.`
      },
      {
        question: `Do these companies provide visa sponsorship for ${categoryDisplay.toLowerCase()}?`,
        answer: `Most companies listed provide visa sponsorship for qualified candidates. During the application process, you can specify your visa requirements, and companies will indicate if they can provide sponsorship.`
      },
      {
      ...
      },
      {
        ...
        answer: `Standard benefits usually include: monthly salary, shared or private accommodation, transportation allowance, health insurance, annual leave, end-of-service benefits, and sometimes performance bonuses.`
      },
      {
        question: `How do I prepare for interviews with companies in ${cityDisplay}?`,
        answer: `Research the company background, prepare to discuss your relevant experience, practice common interview questions, dress professionally, and be ready to demonstrate your skills. Companies appreciate punctuality and positive attitude.`
      },
      {
        question: `Is it safe to work in ${cityDisplay} as a ${categoryDisplay.toLowerCase()}?`,
        answer: `Yes, ${cityDisplay} has strict labor laws protecting workers' rights. The UAE government ensures safe working conditions, fair treatment, and proper compensation. All listed companies must comply with UAE labor regulations.`
      },
      {
      ...
      },
      {
        ...
        answer: `Yes, UAE labor laws allow job changes. However, there are specific procedures to follow, and you may need a No Objection Certificate (NOC) from your current employer or wait for the end of your contract period.`
      },
      {
      ...
      },
      {
        ...
        answer: `Working hours vary by company and role. Most follow a 6-day work week with 8-10 hour shifts. Some positions may require shift work, overtime, or weekend duties, which are typically compensated according to UAE labor law.`
      }
    ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Latest {categoryDisplay} Jobs in {cityDisplay}
            </h1>
            <p className="text-xl text-gray-200 mb-6 max-w-3xl mx-auto">
              Apply online to top companies hiring {categoryDisplay.toLowerCase()} in {cityDisplay}. 
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 sm:p-8 mb-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-700 leading-relaxed max-w-3xl mx-auto">
              ...
              get hired faster through our streamlined application process.
            </p>
          </div>
