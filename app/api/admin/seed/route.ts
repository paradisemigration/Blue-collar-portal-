...
function generateSampleProfiles() {
  ...
  const getJobCategory = (jobTitle: string): string => {
    const categoryMap: Record<string, string> = {
      ...
      'Cook (Home-based)': 'Domestic & Personal Care Workers',
      'Elderly Caregiver': 'Domestic & Personal Care Workers',
      'Babysitter': 'Domestic & Personal Care Workers',
      'Domestic Helper': 'Domestic & Personal Care Workers',
      'Governess (Live-in Tutor/Nanny)': 'Domestic & Personal Care Workers',
      'Housekeeper (Residential)': 'Domestic & Personal Care Workers',
      'Personal Attendant': 'Domestic & Personal Care Workers',
      'Live-in Maid': 'Domestic & Personal Care Workers',
      'Maid': 'Domestic & Personal Care Workers',
      ...
      'Steel Fixer': 'Construction & Infrastructure',
      'Scaffold Worker': 'Construction & Infrastructure',
      'Tile Setter': 'Construction & Infrastructure',
      'HVAC Technician': 'Construction & Infrastructure',
      'Crane Operator': 'Construction & Infrastructure',
      'Heavy Equipment Operator': 'Construction & Infrastructure',
      'Site Supervisor': 'Construction & Infrastructure',
      'Road Construction Worker': 'Construction & Infrastructure',
      'Roofer': 'Construction & Infrastructure',
      'Glazier': 'Construction & Infrastructure',
      'Pipe Fitter': 'Construction & Infrastructure',
      'Concrete Mixer': 'Construction & Infrastructure',
      'Excavator Operator': 'Construction & Infrastructure',
      'Construction Worker': 'Construction & Infrastructure',

      // Mechanical & Technical
      'Auto Mechanic': 'Automotive & Technical',
      'Diesel Mechanic': 'Automotive & Technical',
      'Machine Operator': 'Automotive & Technical',
      'CNC Machine Operator': 'Automotive & Technical',
      'Fitter': 'Automotive & Technical',
      'Maintenance Technician': 'Automotive & Technical',
      'Elevator Technician': 'Automotive & Technical',
      'AC Technician': 'Automotive & Technical',
      'Forklift Operator': 'Automotive & Technical',
      'Lathe Machine Operator': 'Automotive & Technical',
      'Mechanic': 'Automotive & Technical',

      // Manufacturing & Factory
      'Factory Worker': 'Manufacturing & Industrial',
      'Assembly Line Worker': 'Manufacturing & Industrial',
      'Packer': 'Manufacturing & Industrial',
      'Warehouse Associate': 'Manufacturing & Industrial',
      'Quality Checker': 'Manufacturing & Industrial',
      'Production Supervisor': 'Manufacturing & Industrial',
      'Fabricator': 'Manufacturing & Industrial',
      'Loader/Unloader': 'Manufacturing & Industrial',
      'Warehouse Worker': 'Manufacturing & Industrial',
      'Textile Factory Worker': 'Manufacturing & Industrial',

      // Transport & Logistics
      'Truck Driver': 'Transport & Logistics',
      'Delivery Driver': 'Transport & Logistics',
      'Bus Driver': 'Transport & Logistics',
      'Light Vehicle Driver': 'Transport & Logistics',
      'Logistics Assistant': 'Transport & Logistics',
      'Dispatch Coordinator': 'Transport & Logistics',
      'Heavy Vehicle Driver': 'Transport & Logistics',
      'Driver': 'Transport & Logistics',
      'Food Delivery Rider': 'Transport & Logistics',

      // Cleaning & Maintenance
      'Cleaner': 'Cleaning & Maintenance',
      'Housekeeping Staff': 'Cleaning & Maintenance',
      'Janitor': 'Cleaning & Maintenance',
      'Building Maintenance Worker': 'Cleaning & Maintenance',
      'Car Wash Attendant': 'Cleaning & Maintenance',
      'Office Cleaner': 'Cleaning & Maintenance',
      'Road Worker': 'Cleaning & Maintenance',
      'Building Maintenance': 'Cleaning & Maintenance',
      'Pool Cleaner': 'Cleaning & Maintenance',
      'Window Cleaner': 'Cleaning & Maintenance',
      'Maintenance Helper': 'Cleaning & Maintenance',
      'Cleaning Supervisor': 'Cleaning & Maintenance',
      'Maintenance Supervisor': 'Cleaning & Maintenance',

      // Hospitality & Food
      'Cook': 'Hospitality & Food',
      'Kitchen Helper': 'Hospitality & Food',
      'Waiter': 'Hospitality & Food',
      'Dishwasher': 'Hospitality & Food',
      'Restaurant Cleaner': 'Hospitality & Food',
      'Barista': 'Hospitality & Food',
      'Food Preparation Worker': 'Hospitality & Food',

      // Security & Safety
      'Security Guard': 'Security & Safety',
      'Watchman': 'Security & Safety',
      'Lifeguard': 'Security & Safety',

      // Agriculture & Landscaping
      'Farm Worker': 'Agriculture & Landscaping',
      'Livestock Handler': 'Agriculture & Landscaping',
      'Greenhouse Worker': 'Agriculture & Landscaping',
      'Landscaper': 'Agriculture & Landscaping',
      'Gardener': 'Agriculture & Landscaping',

      // General Services
      'General Helper': 'General Services',
      'Tailor': 'General Services',
      'Ironing Staff': 'General Services',
      'Petrol Pump Attendant': 'General Services',
      'Office Boy': 'General Services',
      'Tea Boy': 'General Services',
      'Baggage Handler': 'General Services',
      'Laundry Worker': 'General Services',
      'Pest Control Worker': 'General Services',
      'Cashier': 'General Services',
      'Shop Assistant': 'General Services',
      'Inventory Clerk': 'General Services',
      'Loading Worker': 'General Services',
      'Moving Helper': 'General Services'
    }
