...
// Profile picture URLs for realistic diversity
...
const WORKER_NAMES = {
  male: [
    'Ahmed Hassan', 'Mohammed Ali', 'Rajesh Kumar', 'Omar Al-Rashid', 'Hassan Abdullah',
    'Amit Singh', 'Abdul Rahman', 'Sanjay Patel', 'Fahad Al-Mansouri', 'Ravi Sharma',
    'Ali Al-Zahra', 'Deepak Kumar', 'Salem Al-Rashid', 'Prakash Reddy', 'Khalid Al-Otaibi',
    'Anwar Sheikh', 'Manish Gupta', 'Tariq Al-Mahmoud', 'Sunil Kumar', 'Faisal Al-Harbi',
    'Vikram Singh', 'Abdullah Al-Rashid', 'Naveen Kumar', 'Yaseen Al-Zaabi', 'Rohit Sharma',
    'Mustafa Al-Hashemi', 'Rajesh Gupta', 'Saeed Al-Mansoori', 'Arun Kumar', 'Hamad Al-Thani'
  ],
  female: [
    'Maria Santos', 'Fatima Al-Zahra', 'Priya Sharma', 'Aisha Abdullah', 'Rose Garcia',
    'Zainab Hassan', 'Sunita Devi', 'Mariam Al-Rashid', 'Jennifer Lopez', 'Khadija Ahmed',
    'Divya Patel', 'Sara Al-Mansouri', 'Catherine David', 'Noor Al-Hashemi', 'Anita Singh',
    'Lila Al-Otaibi', 'Grace Emmanuel', 'Huda Al-Mahmoud', 'Rekha Kumari', 'Mona Al-Zaabi'
  ]
}
...
function generateWorkerProfile(
  ...
  const fullName = nameArray[nameIndex % nameArray.length]
  const profilePicture = getRandomElement(pictureArray)
